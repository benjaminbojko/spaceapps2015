...
public class BodySourceView : MonoBehaviour
{
    ...
    // added for cloth and collider stuff
    ...
    void Start()
    {
        cloth = GameObject.FindGameObjectWithTag("Cloth");
        c = cloth.GetComponent<Cloth>();
        cap = new CapsuleCollider[2];
    }
    ...
    private GameObject CreateBodyObject(ulong id)
    {
        ...
        body.transform.localScale = new Vector3(12.0f, 12.0f, 12.0f);

        int i = 0;
        for (Kinect.JointType jt = Kinect.JointType.SpineBase; jt <= Kinect.JointType.ThumbRight; jt++)
        {
            if (jt.ToString() == "HandLeft" || jt.ToString() == "HandRight")
            {
